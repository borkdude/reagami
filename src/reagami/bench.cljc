...
(defn benchmark []
  (let []
    ...
    (let [new-time (measure "New renderer" #(dotimes [_ 1000] (new/render container2 (hiccup))))
          old-time (measure "Old renderer" #(dotimes [_ 1000] (old/render container1 (hiccup))))]
